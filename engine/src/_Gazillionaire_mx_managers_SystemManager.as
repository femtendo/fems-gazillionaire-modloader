package
{
   ...
   [SWF(width="760", height="570", backgroundColor="#ffffff", frameRate="24")]
   public class _Gazillionaire_mx_managers_SystemManager extends SystemManager implements IFlexModuleFactory, ISWFContext
   {
      ...
      public function _Gazillionaire_mx_managers_SystemManager()
      {
      ...
      override public function create(... rest) : Object
      {
         ...
         var _loc2_:String = rest.length == 0 ? "Gazillionaire" : String(rest[0]);
      ...
      override public function info() : Object
      {
         if(!this._info)
         {
            this._info = {
               ...
               "compiledResourceBundleNames":["collections","components","containers","controls","core","effects","layout","skins","styles","utils"],
               "currentDomain":ApplicationDomain.currentDomain,
               "height":"570",
               "horizontalScrollPolicy":"off",
               "layout":"absolute",
               "mainClassName":"Gazillionaire",
               "mixins":["_Gazillionaire_FlexInit","_Gazillionaire_Styles","mx.styles.StyleManagerImpl","mx.managers.systemClasses.ActiveWindowManager","mx.messaging.config.LoaderConfig"],
